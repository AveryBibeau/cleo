...
import { renderRoute, RenderRouteOptions, RenderFragmentOptions, renderComponent } from '##/lib/view/render'
...
export function makeServer(getTemplate: (url: string) => string) {
  const app = Fastify({
    maxParamLength: 1800,
